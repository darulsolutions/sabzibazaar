        ...
        <div class="container">
            <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                ...
                <div class="main__logo">
                    <a class="main__logo--link" href="index.html"><img class="main__logo--img" src="assets/img/Sabzi pictures/Sabzi_Bazaar_Logo_1_version-02.png" height="150" width="150" alt="logo-img"></a>
                </div>
                    ...
                    <form class="d-flex header__search--form" action="#">
                        <div class="header__select--categories select">
                            <select class="header__select--inner">
                                ...
                                <option value="2">Sabzi Bundle</option>
                                <option value="3">Weekly Sabzi</option>
                                <option value="4">Sabzi of the day</option>
                                <option value="5">Seasonal Sabzi </option>
                            </select>
                        </div>
                ...
                <div class="header__menu d-none d-lg-block header__sticky--block">
                    <nav class="header__menu--navigation">
                        <ul class="d-flex">
                            ...
                            <li class="header__menu--items">
                                <a class="header__menu--link" href="{{ route ('faq') }}">FAQ
                                </a>
                            </li>
                            <li class="header__menu--items">
                                <a class="header__menu--link" href="{{ route ('products') }}">Products
                                    <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                                        <path d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7" />
                                    </svg>
                                </a>
                                <ul class="header__sub--menu">
                                    <li class="header__sub--menu__items"><a href="{{ route('sabzi-of-the-day') }}" class="header__sub--menu__link">Sabzi of the day</a></li>
                                    <li class="header__sub--menu__items"><a href="{{ route('sabzi-bundle') }}" class="header__sub--menu__link">Sabzi Bundle</a></li>
                                    <li class="header__sub--menu__items"><a href="{{ route('seasonal-sabzi') }}" class="header__sub--menu__link">Seasonal Sabzi</a></li>
                                    <li class="header__sub--menu__items"><a href="{{ route('weekly-sabzi') }}" class="header__sub--menu__link">Weekly Sabzi</a></li>
                                </ul>
                            </li>
                            <li class="header__menu--items">
                    ...
                    <ul class="d-flex">
                        ...
                        <li class="header__account--items">
                            <a class="header__account--btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                                ...
                                <span class="items__count" id="total-items"></span>
                            </a>
                        </li>
    ...
    <div class="header__bottom bg__secondary">
        <div class="container">
            <div class="header__bottom--inner position__relative d-flex align-items-center">
                    ...
                    <div class="dropdown__categories--menu">
                        <ul class="d-none d-lg-block">
                            <li class="categories__menu--items">
                                <a class="categories__menu--link" href="{{ route('sabzi-of-the-day') }}">
                                    Sabzi of the day
                                </a>
                            </li>
                            <li class="categories__menu--items">
                                <a class="categories__menu--link" href="{{ route('sabzi-bundle') }}">
                                    Sabzi Bundle
                                </a>

                            </li>
                            <li class="categories__menu--items">
                                <a class="categories__menu--link" href="{{ route('weekly-sabzi') }}">
                                    Weekly Sabzi
                                </a>
                            </li>
                            <li class="categories__menu--items">
                                <a class="categories__menu--link" href="{{ route('seasonal-sabzi') }}">
                                    Seasonal Sabzi
                                </a>
                ...
                <div class="header__right--area d-flex justify-content-evenly align-items-center">
                    <div class="header__menu">
                        <nav class="header__menu--navigation">
                            <ul class="d-flex">
                                <li class="header__menu--items">
                                    <a class="header__menu--link secondary-header__menu--link text-white" href="{{ route ('home') }}">Home
                                    </a>
                                </li>
                                <li class="header__menu--items mega__menu--items">
                                    <a class="header__menu--link secondary-header__menu--link text-white" href="{{ route ('about') }}">About
                                    </a>
                                </li>
                                <li class="header__menu--items">
                                    <a class="header__menu--link secondary-header__menu--link text-white" href="{{ route ('faq') }}">FAQ
                                    </a>
                                </li>
                                <li class="header__menu--items">
                                    <a class="header__menu--link secondary-header__menu--link text-white" href="{{ route ('products') }}">Products
                                        <svg class="menu__arrowdown--icon" xmlns="http://www.w3.org/2000/svg" width="12" height="7.41" viewBox="0 0 12 7.41">
                                            <path d="M16.59,8.59,12,13.17,7.41,8.59,6,10l6,6,6-6Z" transform="translate(-6 -8.59)" fill="currentColor" opacity="0.7" />
                                        </svg>
                                    </a>
                                ...
                                <li class="header__menu--items">
                                    <a class="header__menu--link secondary-header__menu--link text-white" href="{{ route ('contact') }}">Contact </a>
                                </li>
                            </ul>
                        </nav>
                    </div>
        ...
        <div class="offcanvas__inner">
            <div class="offcanvas__logo">
                <a class="offcanvas__logo_link" href="index.html">
                    <img src="assets/img/logo/nav-log.png" alt="SabziBazaar Logo" width="158" height="36">
                </a>
                ...
                <ul class="offcanvas__menu_ul">
                    ...
                    <li class="offcanvas__menu_li">
                        ...
                        <ul class="offcanvas__sub_menu">
                            ...
                            <li class="offcanvas__sub_menu_li"><a href="{{ route('cart') }}" class="offcanvas__sub_menu_item">Cart Page</a></li>
                            <li class="offcanvas__sub_menu_li"><a href="portfolio.html" class="offcanvas__sub_menu_item"> Page</a></li>
        ...
        <div class="minicart__product">
            <!-- <div class="minicart__product--items d-flex">
                <div class="minicart__thumb">
                    <a href="product-details.html"><img src="" id="minicart__product-img" alt="prduct-img"></a>
                </div>
            ...
            <div class="minicart__button d-flex justify-content-center">
                <button class="btn minicart__button--link" id="view-cart-btn" onclick="orderCheck('cart')">View cart</button>
                <button class="btn minicart__button--link" id="checkout-btn" onclick="orderCheck('checkout')">Checkout</button>
            </div>
        </div>
