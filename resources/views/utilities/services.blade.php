<section class="shipping__section section--padding">
        <div class="container">
          <div class="shipping__section--inner d-flex justify-content-center row">
            <div class="shipping__items col-lg-4">
              ...
              <div class="shipping__items--content text-center">
                ...
                <p class="shipping__items--desc">Monday to Friday: 11:00 AM - 10:00 PM</p>
              </div>
            </div>
            <div class="shipping__items col-lg-4">
              <div class="shipping__items--icon">
